...
foreach ($publicaciones as $publicacion) {
    ...
    $usuarios_aplaudieron = $publicacion['usuarios_aplaudieron'];
    ...
    <?php
    // Convertir la lista en un array separando los usuarios por coma
    $usuarios_array = explode(",", $usuarios_aplaudieron);
